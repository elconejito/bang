...
class BulkUpdateMagazineGroupRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        ...
        return [
            ...
            'changes' => ['required', 'array:manufacturer,model_name,model_number,label,color_id,capacity,serial_number,id_marking,calibers,firearms,location_id,loaded_ammunition_id,loaded_rounds,current_firearm_id', 'min:1'],
            ...
            'changes.serial_number' => ['sometimes', 'nullable', 'string', 'max:255'],
            'changes.id_marking' => ['sometimes', 'nullable', 'string', 'max:255'],
