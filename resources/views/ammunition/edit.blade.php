...
@section('title', 'Edit ' . $caliber->label . ' | Ammunition')
            ...
            <form action="{{ route('calibers.ammunitions.update', [$caliber->id, $ammunition->id]) }}" method="post" name="ammunition-edit">
                ...
                <div class="form-group row">
                    <div class="col-sm-4">
                        ...
                        <input type="text" class="form-control" id="manufacturer" name="manufacturer" placeholder="Manufacturer" value="{{ $ammunition->manufacturer }}" required>
                    ...
                    <div class="col-sm-5">
                        ...
                        <input type="text" class="form-control" id="name" name="name" placeholder="Name" value="{{ $ammunition->name }}" required>
                        <small class="form-text text-muted">
                        ...
                        <div class="form-group row">
                            <div class="col-6">
                                ...
                                <select class="form-control" id="shell_type_id" name="shell_type_id">
                                    ...
                                    {!! FormHelper::select(ShellType::all(), 'id', ['label'], $ammunition->shell_type_id) !!}
                                </select>
                                <small class="form-text text-muted">
                        ...
                        <div class="form-group row">
                            <div class="col-6">
                                ...
                                <select class="form-control" id="shell_length_id" name="shell_length_id">
                                    <option>- Select One -</option>
                                    {!! FormHelper::select(ShellLength::all(), 'id', ['label'], $ammunition->shell_length_id) !!}
                                </select>
                                <small class="form-text text-muted">
                            ...
                            <div class="col-6">
                                ...
                                <select class="form-control" id="shot_material_id" name="shot_material_id">
                                    <option>- Select One -</option>
                                    {!! FormHelper::select(ShotMaterial::all(), 'id', ['label'], $ammunition->shot_material_id) !!}
                                </select>
                                <small class="form-text text-muted">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-3">
                                ...
                                <select class="form-control" id="bullet_type_id" name="bullet_type_id">
                                    <option>- Select One -</option>
                                    {!! FormHelper::select(BulletType::all(), 'id', ['label'], $ammunition->bullet_type_id) !!}
                                </select>
                                <small class="form-text text-muted">
                            ...
                            <div class="col-sm-3">
                                ...
                                <select class="form-control" id="ammunition_casing_id" name="ammunition_casing_id">
                                    <option>- Select One -</option>
                                    {!! FormHelper::select(AmmunitionCasing::all(), 'id', ['label'], $ammunition->ammunition_casing_id) !!}
                                </select>
                                <small class="form-text text-muted">
                        ...
                        <div class="form-group row">
                            <div class="col-sm-3">
                                ...
                                <select class="form-control" id="ammunition_condition_id" name="ammunition_condition_id">
                                    <option>- Select One -</option>
                                    {!! FormHelper::select(AmmunitionCondition::all(), 'id', ['label'], $ammunition->ammunition_condition_id) !!}
                                </select>
                                <small class="form-text text-muted">
                            ...
                            <div class="col-sm-3">
                                ...
                                @else
                                    <select class="form-control" id="primer_type_id" name="primer_type_id">
                                        <option>- Select One -</option>
                                        {!! FormHelper::select(PrimerType::all(), 'id', ['label'], $ammunition->primer_type_id) !!}
                                    </select>
                                @endif
                                <small class="form-text text-muted">
